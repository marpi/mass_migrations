...
(function (window){
    ...
    MarchingSquares.step = function(index, data, width4){
        ...
        MarchingSquares.upLeft = data[index + 2] > 0;//hack + 3
        MarchingSquares.upRight = data[index + 6] > 0;//hack + 7
        MarchingSquares.downLeft = data[index + width4 + 2] > 0;//hack + 3
        MarchingSquares.downRight = data[index + width4 + 6] > 0;//hack + 7
